        ...
        <div class="p-1 px-3 bg-white text-black flex justify-between items-center">
            ...
            <div class="hidden lg:flex items-center">
                ...
                <div id="dropdownHover"
                    class="z-10 hidden bg-white divide-y divide-gray-100 rounded-b-lg   w-full dark:bg-gray-700">
                    <ul class="py-5 px-10 flex text-sm text-gray-700 dark:text-gray-200"
                        aria-labelledby="dropdownHoverButton">
                        <li class="flex flex-col w-1/4">
                            <h1 class="italic font-semibold text-xl text-gray-600">Safari Tips</h1>
                            <ul class="text-gray-800 text-lg ml-2 list-disc">
                                <li>Park light</li>
