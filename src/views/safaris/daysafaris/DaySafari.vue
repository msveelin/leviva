<template>
    <div>
        ...
        <div class="p-10 text-justify">
            ...
            <p>Your adventure begins with the promise of discovery, where the rhythm of the wilderness sets the tempo for an
            ...
            <div class="mt-5 p-2 grid-cols-1 grid lg:grid-cols-4 gap-6">
                <div class="p-1 rounded-md bg-black arusha h-96 flex flex-col justify-end">
                    <div class="p-2  mt-1">
                        ...
                        <button class="menu-btn w-full  "><router-link to="arusha-day-safari">VIEW MORE</router-link></button>
                    </div>
                </div>
                <div class="p-1 rounded-md bg-black tarangire h-96 flex flex-col justify-end">
                    <div class="p-2  mt-1">
                        ...
                        <button class="menu-btn w-full  "><router-link to="/tarangire-day-safari">VIEW MORE</router-link></button>
                    </div>
                </div>
                <div class="p-1 rounded-md bg-black chemka h-96 flex flex-col justify-end">
                    <div class="p-2  mt-1">
                        <h1 class="text-xl font-bold mb-1">Chemka Hot Springs</h1>
                        <button class="menu-btn w-full  "><router-link to="chemka-day-safari">VIEW MORE</router-link></button>
                    </div>
                </div>
            </div>
        </div>
...
<style scoped>
.intro {
    background-image: url("@/assets/images/daysafari-bg.jpg");
...
.tarangire {
    background-image: url("@/assets/images/IMG_9393.jpg");
    background-size: cover;
    object-fit: cover;
    background-position: center;
    background-repeat: no-repeat;
...
.chemka {
    background-image: url("@/assets/images/chemka.jpg");
    background-size: cover;
    object-fit: cover;
    background-position: center;
    background-repeat: no-repeat;
